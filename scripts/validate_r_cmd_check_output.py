...
class Check:
    ...
    def process(self):
        ...
        allowed_regex_list = [
            ...
            r"^    java  .*Mb",
            r"^\* checking Rd line widths ... NOTE",
            r"^  Rd file 'h2o.abs.Rd':",
            r"^    \examples lines wider than 100 characters:",
            r"^      smtreesH2O <- h2o.importFile(\"https://s3.amazonaws.com/h2o-public-test-data/smalldata/gbm_test/smtrees.csv\")",
